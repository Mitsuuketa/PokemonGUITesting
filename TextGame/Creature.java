...
public class Creature {
    ...
    public Creature(String name, String type, String family, int evoLvl, int hp, boolean isActive, boolean isCaptured, int id) {
        this.name = name;
        this.type = type;
        this.family = family;
        this.evoLvl = evoLvl;
     ...
     */
    public void setStarterCreature(Scanner scanner, ArrayList<Creature> creaturesList, ArrayList<Creature> capturedList) {
        ArrayList<Creature> evoLvl1 = new ArrayList<Creature>();
        Game game = new Game();
        ...
        int currentIndex = 1;
        Creature chosenStarter = null;

        while(chosenStarter == null) {
            for(Creature creature : evoLvl1) {
