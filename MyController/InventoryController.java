...
public class InventoryController {
    ...
    private ArrayList<CreatureController> capturedList = new ArrayList<>();
    private Game game; 
    ...
    public InventoryController(ArrayList<CreatureController> capturedList) {
    ...
    public void changeCreature(Scanner scanner) {
        CreatureController lastCaptured = null;
     ...
     */
    public CreatureController getActiveCreature() {
