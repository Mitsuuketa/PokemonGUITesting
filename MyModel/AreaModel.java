...
public class AreaModel {
   ...
   // parameters: `capturedList`, `creaturesList`, and `inventory`.
    public AreaModel(ArrayList<CreatureModel> capturedList, ArrayList<CreatureModel> creaturesList, InventoryModel inventory) {
        this.playerX = 0;
        this.playerY = 0;
        this.battle = new BattleModel(capturedList, creaturesList, inventory);
        this.game = new Game();
    }
