...
public class Game {
    ...
    public Game(int choice) {
        ...
        this.inventory = new InventoryModel(capturedList);
        this.evo = new EvolutionModel(capturedList, creaturesList);
        this.area = new AreaModel(capturedList, creaturesList, inventory);
    }
    ...
    public void resetGame() {
        List<CreatureModel> copyList = new ArrayList<>(capturedList); // Create a copy of the list

        for (CreatureModel creature : copyList) {
